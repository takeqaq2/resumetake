...
export const translations = {
  zh: {
    ...
    editor: {
      ...
      uploadFile: '上传文件',
      uploadHint: '为安全起见，仅支持 TXT、MD 文本文件，最大 1MB',
  ...
  en: {
    ...
    editor: {
      ...
      uploadHint: 'For safety, only TXT and MD text files are supported, max 1MB',
  ...
  ja: {
    ...
    editor: {
      ...
      uploadHint: '安全のため TXT/MD テキストのみ対応、最大1MB',
  ...
  ko: {
    ...
    editor: {
      ...
      uploadFile: '파일 업로드',
      uploadHint: '보안을 위해 TXT/MD 텍스트 파일만 지원, 최대 1MB',
  ...
  es: {
    ...
    editor: {
      ...
      uploadHint: 'Por seguridad, solo TXT/MD, máx 1MB',
  ...
  pt: {
    ...
    editor: {
      ...
      uploadHint: 'Por segurança, apenas TXT/MD, máx 1MB',
  ...
  fr: {
    ...
    editor: {
      ...
      uploadHint: 'Par sécurité, seuls TXT/MD sont acceptés, max 1 Mo',
  ...
  de: {
    ...
    editor: {
      ...
      uploadHint: 'Aus Sicherheitsgründen nur TXT/MD, max. 1MB',
  ...
  ar: {
    ...
    editor: {
      ...
      uploadHint: 'للسلامة، يدعم TXT/MD فقط، حد أقصى 1 ميجا',
  ...
  hi: {
    ...
    editor: {
      ...
      uploadHint: 'सुरक्षा के लिए केवल TXT/MD, अधिकतम 1MB',
